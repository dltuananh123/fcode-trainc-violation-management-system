/**
 * @file seed_data.c
 * @brief Seed-data generator for demo/testing.
 *
 ...
 *
 * This tool is linked against the project's object files (utils.o, fileio.o,
 * etc.) to reuse hashPassword, generateSalt, xorBuffer, and calculateCrc32 —
 * eliminating code duplication and preventing drift between seed data
 * and the main app.
 *
 * Build: make seed
 * Run:   bin/seed_data.exe [clear]
 */
#include "fileio.h"
#include "types.h"
#include "utils.h"
